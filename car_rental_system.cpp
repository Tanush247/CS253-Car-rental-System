    ...
    while(getline(file,line)){
        ...
        while(getline(ss,cell,',')){
            if(iteration==0){
                ...
                if(cell=="0"){
                    std::cout<<"Model: "<<model<<" Price: "<<price<<" "<<"Car Not Rented"<<endl;
                    break;
                }
            }
            else if(iteration==4){
                ...
                std::cout<<"Model: "<<model<<" Price: "<<price<<" Rented by: "<<name<<" ID: "<<ID<<" Type: "<<type<<" Due Date: "<<due_date<<" Condition: "<<condition<<endl;
            }
            iteration++;
        }
    }
